...
using ASPNETCoreTemplate.Application.Schemas.Requests.Authentication;
...
using ASPNETCoreTemplate.Application.UseCases.Authentication.Register;
using ASPNETCoreTemplate.Application.UseCases.Authentication.RenewToken;
using ASPNETCoreTemplate.Application.UseCases.Authentication.SignIn;
using ASPNETCoreTemplate.Application.UseCases.Authentication.SignOut;
using ASPNETCoreTemplate.WebAPI.Abstractions.Controller;
using ASPNETCoreTemplate.WebAPI.Attributes;
using MapsterMapper;
using MediatR;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;

namespace ASPNETCoreTemplate.WebAPI.Controllers;
